...
4. Here are 4 mods that can be directly downloaded to `YOUR_MINECRAFT_GAME_LOCATION/mods` folder: 
   ...
   * [Better Respawn](https://modrinth.com/mod/better-respawn/version/forge-1.19-2.0.0): or just download this file and move it to the mod folder? (don't use step 5?)
